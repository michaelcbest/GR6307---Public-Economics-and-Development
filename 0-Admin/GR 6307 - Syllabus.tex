...
\item \fullcite{BenabouTirole2006}.$^{**(4/5)}$
...
\item \textbf{\fullcite{DalBoetal2013}}.$^{**(4/26)}$
\item \fullcite{Deserrano2017}.
\item \fullcite{LeaverEtAl2022}.
\item \fullcite{Xu2018}.$^{*(4/26)}$
\end{enumerate}
