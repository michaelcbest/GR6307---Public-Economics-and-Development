...
\item \fullcite{BesleyCoate1992}.$^{*(3/1)}$
\item \fullcite{BrewerSaezShephard2010}.
\item \fullcite{KlevenKopczuk2011}.
\item \textbf{\fullcite{NicholsZeckhauser1982}.$^{**(3/1)}$}
...
\item \fullcite{DeshpandeLi2017}.$^{*(3/8)}$
\item \textbf{\fullcite{FinkelsteinNoto2019}.$^{**(3/8)}$}
\item \fullcite{KlevenKopczuk2011}.
...
\item \textbf{\fullcite{Alatasetal2016}.$^{**(3/22)}$}
...
\item \fullcite{Barnwal2017}.$^{*(3/22)}$
...
\item \textbf{\fullcite{Cunhaetal2017}.$^{**(3/29)}$}
\item \fullcite{EggerEtAl2021}.$^{*(3/29)}$
